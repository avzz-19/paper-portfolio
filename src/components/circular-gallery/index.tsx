...
class Media {
  ...
  update(
    ...
    const H = this.viewport.width / 1.5; // Wider arc for landscape images
  ...
  onResize({
    ...
    // Make images wider (landscape aspect ratio ~4:3)
    this.plane.scale.y =
...
class App {
  ...
  createGeometry() {
    this.planeGeometry = new Plane(this.gl, {
      heightSegments: 40,
      widthSegments: 60, // Reduced segments for better performance
    });
  }

  createMedias(
    items: { image: string; text: string }[] | undefined,
    bend: number = 2, // Slightly more bend for better landscape viewing
    textColor: string,
    borderRadius: number,
    font: string
  ) {
    const defaultItems = [
      {
        image: `/images/certificates/appknox.png`,
        text: "Appknox",
      },
      {
        image: `/images/certificates/codedamn.png`,
        text: "Codedamn",
      },
      {
        image: `/images/certificates/Hack-o-Heist.png`,
        text: "Hack-o-Heist",
      },
      {
        image: `/images/certificates/ibm2.png`,
        text: "IBM",
      },
      {
      ...
      {
        image: `/images/certificates/microsoft2.png`,
      ...
      {
        image: `/images/certificates/Udemy2.png`,
        text: "Udemy Web Development",
      },
      {
        image: `/images/certificates/phase-shift.png`,
        text: "Hackathon",
      },
      {
        image: `/images/certificates/RevaHack.png`,
        text: "Reva Hack",
      },
      {
  ...
  onResize() {
    ...
    const height = 2 * Math.tan(fov / 3) * this.camera.position.z; // Wider field of view
